...
public class PayActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blockchainType = BrahmaConst.ETH_ACCOUNT_TYPE;
    ...
    private void showAccounts() {
        if (accounts != null && accounts.size() > 0) {
            ...
            for (final AccountEntity accountEntity : accounts) {
                ...
                accountItemView.layoutAccountItem = LayoutInflater.from(PayActivity.this).inflate(R.layout.list_item_pay_account, null);
                ...
                ImageManager.showAccountAvatar(PayActivity.this, accountItemView.ivAccountAvatar, accountEntity);
    ...
    private void showEthPasswordDialog() {
        ...
        AlertDialog passwordDialog = new AlertDialog.Builder(PayActivity.this, R.style.Theme_AppCompat_Light_Dialog_Alert_Self)
                .setView(dialogView)
                .setCancelable(false)
